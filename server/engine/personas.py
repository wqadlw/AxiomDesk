...
def _lens_line(features: dict, dim_key: str) -> str:
    ...
    if dim_key == "13_policy":
        tags = []
        if features.get("ai_theme") or features.get("is_tech"):
            tags.append("AI/科技政策红利")
        if features.get("is_new_energy"):
            tags.append("新能源政策")
...
PERSONAS: dict[str, dict] = {
    "buffett": {
        "name": "巴菲特",
        "style": "只买能看懂、能算清内在价值、且价格远低于价值的生意。",
        "open": "我用所有者视角看这门生意：",
        "close": "价格是我付出的，价值是我得到的——现在这笔账还划算。",
        "catchphrase": "价格是你付出的，价值是你得到的。",
    },
    "munger": {
        "name": "芒格",
        "style": "反过来想，总是反过来想；避开愚蠢比追求聪明更重要。",
        "open": "反过来想：这家公司最可能在哪儿把我坑了？",
        "close": "只要不犯大错，复利自会照顾我们。",
        "catchphrase": "如果我知道自己会死在哪里，我就永远不去那里。",
    },
    "graham": {
        "name": "格雷厄姆",
        "style": "市场先生是情绪化的仆人，不是向导；安全边际是唯一的护身符。",
        "open": "把市场先生当作报价机：",
        "close": "唯有足够的安全边际，才值得我出手。",
        "catchphrase": "市场短期是投票机，长期是称重机。",
    },
    "fisher": {
        "name": "费雪",
        "style": "买那些会持续长大的伟大企业，然后长期持有。",
        "open": "我更关心这门生意十年后会怎样：",
        "close": "好生意值得用时间换空间。",
    ...
    "lynch": {
        "name": "彼得·林奇",
        "style": "投资你熟悉的东西；PEG 一把尺子量尽成长与估值。",
        "open": "咱老百姓也能懂的生意：",
        "close": "PEG 不高、故事能讲通，我就愿意拿着。",
        "catchphrase": "不做研究就别买股票，买股票前先买这家公司的产品。",
    },
    "soros": {
        "name": "索罗斯",
        "style": "市场是反身性的；当趋势与基本面自我强化到临界点，就要押注拐点。",
        "open": "反身性告诉我：",
        "close": "拐点一旦确认，趋势会自己养肥自己。",
        "catchphrase": "判断对错不重要，重要的是对的时候赚多少。",
    },
    "dalio": {
        "name": "达里奥",
        "style": "理解债务周期与国运；用全天候的视角对冲风险。",
        "open": "把它放进宏观债务周期里看：",
        "close": "分散与对冲，比押注单一方向更稳妥。",
        "catchphrase": "痛苦+反思=进步。",
    },
    "marks": {
        "name": "霍华德·马克斯",
        "style": "第二层思维；人取我弃，在别人恐慌时找便宜货。",
        "open": "第一层思维都说它好时，我要想第二层：",
        "close": "便宜才是硬道理，贵了再好也不买。",
        "catchphrase": "周期是永恒的，而极端终会回归。",
    },
    "livermore": {
        "name": "利弗莫尔",
        "style": "只做右侧、等关键点；让利润奔跑，砍掉亏损。",
        "open": "关键点没到，我不动：",
        "close": "趋势对我有利，就拿住；不对就走。",
        "catchphrase": "赚钱的不是想法，而是静等关键点出现的耐心。",
    },
    "duan": {
        "name": "段永平",
        "style": "本分；买股票就是买公司，好的生意模式最重要。",
        "open": "本分地看这门生意模式：",
        "close": "生意模式好、价格合理，我就舒服地拿着。",
        "catchphrase": "买股票就是买公司，和公司一起赚真金白银。",
    },
    "zhangkun": {
        "name": "张坤",
        "style": "与伟大企业共舞，用长期视角对抗短期波动。",
        "open": "我希望陪这样的公司滚雪球：",
        "close": "时间会是好公司的朋友。",
    ...
    "zhao_lg": {
        "name": "赵老哥",
        "style": "打板龙头，二板定龙头，龙头不言顶。",
        "open": "情绪与地位我看得很重：",
        "close": "龙头不猜顶，杂毛不抄底，只做最强。",
        "catchphrase": "二板定龙头，龙头不言顶。",
    },
    "wood": {
        "name": "木头姐",
        "style": "押注破坏性创新；用 5 年复合视野看爆发。",
        "open": "我在赌一场范式转移：",
        "close": "只要创新曲线成立，短期波动只是噪声。",
        "catchphrase": "创新会重新定义行业，赢家通吃。",
    },
    "simons": {
        "name": "西蒙斯",
        "style": "模式与概率；不谈故事，只看统计显著性。",
        "open": "我不讲故事，只看信号：",
        "close": "正期望的交易，重复做就够了。",
    ...
    "yangjia": {
        "name": "炒股养家",
        "style": "揣摩市场情绪，别人贪婪我更贪婪、别人恐慌我捡恐慌。",
        "open": "情绪的钟摆我盯着：",
        "close": "别人恐慌处，往往是我出手处。",
