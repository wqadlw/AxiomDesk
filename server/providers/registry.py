...
def get_meta(pid: str) -> dict:
    return PROVIDER_META.get(pid, {"id": pid, "name": pid, "builtin": False,
                                   "requires_token": False, "desc": "", "install": ""})
